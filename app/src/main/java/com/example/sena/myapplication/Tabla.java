...
/**
 * Created by Marcelo on 27/10/2015.
 */
public class Tabla {
    ...
    String[] arraycabecera ={"Cuota"};
        ...
        for(int i = 0; i < arraycabecera.length; i++)
        {
            ...
            texto.setBackgroundResource(R.drawable.abc_popup_background_mtrl_mult);
    ...
    public void agregarFilaTabla(ArrayList<String> elementos)
    {
        ...
        for(int i = 0; i< elementos.size(); i++)
        {
            ...
            texto.setGravity(Gravity.CENTER_HORIZONTAL);
            texto.setBackgroundResource(R.drawable.abc_ab_share_pack_holo_dark);
